...
func TestAddress(t *testing.T) {
	...
	g.Describe("Address", func() {

		g.Describe(".IsValidHostPortAddress", func() {
			g.It("should return false if params is 'abc'", func() {
				Expect(IsValidHostPortAddress("abc")).To(BeFalse())
			})

			g.It("should return true if params is '1.1.1.1:1234'", func() {
				Expect(IsValidHostPortAddress("1.1.1.1:1234")).To(BeTrue())
			})
		})

		g.Describe(".IsValidFullMultiaddr", func() {

			g.It("Should return false for all cases ", func() {
		...
		g.Describe(".RemoteAddrFromStream", func() {
			...
			g.It("should return get address from stream", func() {
		...
		g.Describe(".RemoteAddrFromConn", func() {
			var host host.Host
			...
			g.It("should return /ip4/127.0.0.1/tcp/40103/ipfs/12D3KooWE3AwZFT9zEWDUxhya62hmvEbRxYBWaosn7Kiqw5wsu73", func() {
		...
		g.Describe(".AddressFromHost", func() {
			var host host.Host

			g.It("should return empty address when nil is passed", func() {
				addr := AddressFromHost(nil)
				Expect(addr).To(Equal(NodeAddr("")))
			})

			g.It("should return /ip4/127.0.0.1/tcp/40104/ipfs/12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42", func() {
				var err error
		...
		g.Describe(".IDFromAddr", func() {
			g.It("should return 12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42", func() {
		...
		g.Describe(".IDFromAddrString", func() {
			g.It("should return empty string if address is invalid", func() {
		...
		g.Describe(".ParseAddr", func() {
			g.It("should return tcp = 40104, ip4 = 127.0.0.1, ip6= and ipfs=12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42", func() {
			...
			g.It("should return nil when addr is invalid", func() {
				result := ParseAddr("/ip427.0.0.1/tcp04/ipfs2D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42")
				Expect(result).To(BeNil())
			})
		})

		g.Describe(".GetIPFromAddr", func() {
			g.It("should return ip4 ip", func() {
			...
			g.It("should return ip6 ip", func() {
		...
		g.Describe(".ShortID", func() {
			g.It("should return empty string", func() {
				Expect(ShortID(peer.ID(""))).To(Equal(""))
			})

			g.It("should return 'CovLVG4fQcqR..oMt32Q6LgZDK'", func() {
				Expect(ShortID(peer.ID("12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42"))).To(Equal("CovLVG4fQcqR..oMt32Q6LgZDK"))
			})
		})

		g.Describe(".IsRoutableAddr", func() {
			g.It("should return false when addr is not a valid multiaddr", func() {
				valid := IsRoutableAddr("invalid_addr")
				Expect(valid).To(BeFalse())
			})

			g.It("should return false when addr is '/ip4/0.0.0.0/tcp/40104/ipfs/12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42'", func() {
				addr := "/ip4/0.0.0.0/tcp/40104/ipfs/12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42"
				valid := IsRoutableAddr(addr)
				Expect(valid).To(BeFalse())
			})

			g.It("should return false when addr is '/ip4/127.0.0.1/tcp/40104/ipfs/12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42'", func() {
				addr := "/ip4/127.0.0.1/tcp/40104/ipfs/12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42"
				valid := IsRoutableAddr(addr)
				Expect(valid).To(BeFalse())
			})

			g.It("should return false when addr is '/ip6/::ffff:abcd:ef12:1/tcp/40104/ipfs/12D3KooWG7YTN3ADjgCqkxXMFQ5tdHUFVDGGU9tXfDHWUV4hUs42'", func() {
		...
		g.Describe(".IsValidConnectionString", func() {

			g.When("scheme is 'ell'", func() {
				g.It("should return true for a valid connection string", func() {
					str := "ell://12D3KooWQJKY8C35U2JCZLaobGueSJnXGcx6Z9FStDXxQKtnhtwy@127.0.0.1:9000"
					Expect(IsValidConnectionString(str)).To(BeTrue())
				})
			})

			g.When("scheme is 'ellcrys'", func() {
				g.It("should return true for a valid connection string", func() {
			...
			g.It("should return false for a valid connection string", func() {
		...
		g.Describe(".ParseConnectionString", func() {
			...
			g.It("should return nil if connection string is invalid", func() {
				str := "stuff://"
				Expect(ParseConnString(str)).To(BeNil())
			})
		})

		g.Describe(".AddressFromConnectionString", func() {
			g.It("should return empty NodeAddr if connection string is invalid", func() {
				str := "stuff://"
				Expect(AddressFromConnString(str)).To(Equal(NodeAddr("")))
			})

			g.Context("using an ip4 address", func() {
				g.It("should return a valid NodeAddr", func() {
					str := "ell://12D3KooWQJKY8C35U2JCZLaobGueSJnXGcx6Z9FStDXxQKtnhtwy@127.0.0.1:9000"
			...
			g.Context("using an ip6 address", func() {
				g.It("should return a valid NodeAddr", func() {
