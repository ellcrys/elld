...
var _ = Describe("Txqueue", func() {
	...
	Describe(".Sort", func() {
		It("should sort in ascending order", func() {
			...
			Expect(q.container[0].Fee.String()).To(Equal("0.2"))
			Expect(q.container[1].Fee.String()).To(Equal("0.5"))
			Expect(q.container[2].Fee.String()).To(Equal("1"))
		})
		...
		It("should sort in descending order", func() {
			...
			Expect(q.container[0].Fee.String()).To(Equal("1"))
			Expect(q.container[1].Fee.String()).To(Equal("0.5"))
			Expect(q.container[2].Fee.String()).To(Equal("0.2"))
		})
	})
})
