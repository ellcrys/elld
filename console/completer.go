...
var initialSuggestions = []prompt.Suggest{
	...
	{Text: "ell.mining()", Description: "Check whether mining is active"},
	{Text: "ell.minerHashrate()", Description: "Get current mining hashrate"},
	...
	{Text: "ell.isSyncing()", Description: "Check whether blockchain synchronization is active"},
	{Text: "ell.getSyncState()", Description: "Get blockchain synchronization status"},
