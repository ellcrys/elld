...
func TestJSONRPC(t *testing.T) {
	...
	g.Describe("JSONRPC", func() {
		...
		g.Describe(".handle", func() {
			...
			g.It("should return 'Parse error' when json is invalid", func() {
			...
			g.It("should return 'Invalid Request' when json rpc version is invalid", func() {
			...
			g.It("should return Method not found' when json rpc method is unknown", func() {
			...
			g.It("should return 'Method not found' when json rpc method is not provided", func() {
			...
			g.It("should return 'Method not found' error", func() {
			...
			g.Context("Successfully call method", func() {
				g.When("ID is added to the request body", func() {
				...
				g.When("ID is not added to the request body", func() {
					g.It("should not return result", func() {
						rpc.apiSet["add"] = APIInfo{
							Namespace: "math",
							Func: func(params interface{}) *Response {
								m := params.(map[string]interface{})
		...
		g.Context("Call private method", func() {
			g.When("authorization is not set", func() {
				g.It("should return error response", func() {
			...
			g.When("authorization format invalid", func() {
				g.It("should return error response", func() {
					rpc.apiSet["echo"] = APIInfo{
						Private:   true,
						Namespace: "test",
			...
			g.When("authorization format is valid", func() {
				g.It("should return error response when bearer token is invalid", func() {
					rpc.apiSet["echo"] = APIInfo{
						Private:   true,
						Namespace: "test",
						Func: func(params interface{}) *Response {
			...
			g.When("authorization format is valid", func() {
				g.It("should be successful when bearer token is valid", func() {
					rpc.apiSet["echo"] = APIInfo{
						Private:   true,
						Namespace: "test",
						Func: func(params interface{}) *Response {
			...
			g.When("authorization format is valid and bearer token is not valid", func() {
				g.It("should be successful when disableAuth is true", func() {
		...
		g.Describe(".AddAPI", func() {
			g.Context("with no namespace provided", func() {
				g.It("should add API", func() {
			...
			g.Context("with a namespace provided", func() {
				g.It("should add API", func() {
					rpc.AddAPI("add", APIInfo{
						Namespace: "math",
						Func: func(params interface{}) *Response {
		...
		g.Describe(".Methods", func() {
			g.It("should return all methods name", func() {
				apiSet1 := APISet(map[string]APIInfo{
					"add": {
						Namespace: "math",
						Func: func(params interface{}) *Response {
