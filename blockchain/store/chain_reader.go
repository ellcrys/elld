...
func NewChainReader(store common.ChainStorer, chainID string) *ChainRead {
	return &ChainRead{
		chainID: chainID,
		store:   store,
	}
...
func (r *ChainRead) GetBlockByHash(hash string, opts ...common.CallOp) (*wire.Block, error) {
...
func (r *ChainRead) GetHeaderByHash(hash string) (*wire.Header, error) {
