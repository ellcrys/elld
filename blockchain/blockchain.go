...
func (b *Blockchain) Up() error {
	...
	// Register active object functions and start the active object engine
	b.registerFuncs()
	b.activeObj.Start()
...
func (b *Blockchain) registerFuncs() {
	b.activeObj.RegisterFunc("getBestChain", func(args ...interface{}) interface{} {
		return nil
	})
}
